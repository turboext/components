...
export class ExtMgidWidget extends React.PureComponent<IState> {
        ...
        return this.state.loadingState === LoadingState.failed ?
            ...
            (
                <ExtEmbed
                    ...
                    iframeClass="ext-embed__ext-mgid-widget"
    ...
    private makeScriptUrl(params: WidgetParams): string {
        ...
        return `https://jsc.mgid.com/${publisherStr[0]}/${publisherStr[1]}/` +
